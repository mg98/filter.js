...
describe('interpret syntax from input', () => {
    ...
    it('multiple logical connections', () => {
        expect(
            extractWords("name = 'Wolfram' and age >= 18 or age = 0")
        ).toEqual([
    ...
    it('array of strings (no space)', () => {
        expect(
            extractWords("company in ('Apple','Google','Microsoft') "),
        ).toEqual([
    ...
    it('array of strings and numbers', () => {
        expect(
            extractWords("x in ( 'Apple', 3.141, 'Banana Juice', 8, 200 ) "),
        ).toEqual([
    ...
    it('array of strings and numbers (no space)', () => {
        expect(
            extractWords("x in ('Apple',3.141,'Banana',8,200) "),
        ).toEqual([
            { type: WordType.Field, value: 'x' },
            { type: WordType.Operator, value: 'in' },
    ...
    it('"not in" operator', () => {
        expect(
            extractWords("x not in ('Apple' 3.141 'Banana' 8 200) "),
        ).toEqual([
            { type: WordType.Field, value: 'x' },
    ...
    it('grouping', () => {
        expect(
            extractWords("a = 1 and (b = 2 or b > 10)"),
        ).toEqual([
            { type: WordType.Field, value: 'a' },
            { type: WordType.Operator, value: '=' },
    ...
    it('depth grouping', () => {
        expect(
            extractWords("a = 1 and (b = 2 or (b > 10 or c = 4)) and a != 0"),
        ).toEqual([
            { type: WordType.Field, value: 'a' },
            { type: WordType.Operator, value: '=' },
            { type: WordType.Value, value: 1 },
